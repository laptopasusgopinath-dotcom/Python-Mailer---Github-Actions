import smtplib
from email.mime.text import MIMEText # MIMEText is a class for that represents the text of the email
from email.mime.multipart import MIMEMultipart # MMIMEULtipart is a class that represents the email message itself
import os
